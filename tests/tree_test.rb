...
class TreeTest < Minitest::Test
  ...
  def test_it_can_sort_the_tree
    tree_1 = BinarySearchTree.new
    tree_1.load('./tests/movies2.txt')
    assert_equal [{"I Love You Phillip Morris"=>7}, {"A Ballerina's Tale"=>9}, {"Love"=>11}, {"Meet My Valentine"=>17}, {"Bill & Ted's Bogus Journey"=>36}, {"Charlie's Country"=>38}, {"Crossroads"=>52}, {"Experimenter"=>55}, {"Armageddon"=>58}, {"The Land Before Time XIV: Journey of the Brave"=>65}, {"Hellions"=>67}, {"Collateral Damage"=>69}, {"Hannibal Buress: Animal Furnace"=>71}, {"French Dirty"=>75}, {"A Faster Horse"=>76}, {"A Picture of You"=>79}, {"Hannibal Buress: Comedy Camisado"=>80}, {"Charlie's Angels"=>86}, {"Bill & Ted's Excellent Adventure"=>93}, {"Animals United"=>98}], tree_1.sort
 end
